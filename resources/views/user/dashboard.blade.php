...
<x-templates.base titlePage="Dashboard">
   <x-templates.user._header/>
     ...
     <div id="content-dashboard">
       ...
       <div class="right-side-dashboard">
         <img id="kost-building" src="img/kost.png" alt="gedung kost" />
       </div>
     </div>
     <div id="content-prices">
       ...
       <div id="room-list">
         <div class="room-one">
           <span class="icons">
             <img
               src="https://img.icons8.com/ios/50/null/bedroom-interior.png"
             />
           </span>
